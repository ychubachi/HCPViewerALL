 ...
 */
public class CConsoleTextPane extends JTextPane {

	private static final long serialVersionUID = 1L;

	// 関連
	public PrintStream consoleToStream = null;
	...
	public JTextAreaPrintStream out = new JTextAreaPrintStream(this,
			Color.BLACK);
	public JTextAreaPrintStream err = new JTextAreaPrintStream(this, Color.RED);

	/**
	 * コンストラクタ System.out, System.errのつなぎかえを行います
	 */
	public CConsoleTextPane() {
		this.initialize();
		in.refresh();
	}
...
class JTextAreaPrintStream extends PrintStream {
	...
	// 関連
	private CConsoleTextPane textArea = null;
	 ...
	 * コンストラクタ
	 */
	public JTextAreaPrintStream(CConsoleTextPane textarea, Color color) {
...
class JTextAreaInputStream extends PrintableInputStream {
	 ...
	 */
	public JTextAreaInputStream(CConsoleTextPane textArea) {
		this.textArea = textArea;
		this.initialize();
	}
	...
	private void writeLine() {
		try {
			...
			// 書き込みます
			if (textArea.consoleToStream != null) {
				textArea.consoleToStream.println(lineString);
				textArea.consoleToStream.flush();
			} else {
